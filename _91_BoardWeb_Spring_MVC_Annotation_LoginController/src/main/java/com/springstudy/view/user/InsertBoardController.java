...
import com.springstudy.biz.board.impl.BoardDAOSpringImpl;
...
public class InsertBoardController{
	 ...
	 * title은 BoarVO의 setTitle메서드를 호출해서 값을 저장
	 * writer은 BoarVO의 setWriter메서드를 호출해서 값을 저장
	 * content은 BoarVO의 setContent메서드를 호출해서 값을 저장
	 * 
	 * 매개변수로 BoardDAOImple 객체를 주입해준다.
	 * */
